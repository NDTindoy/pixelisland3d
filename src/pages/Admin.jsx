      ...
      <div className="min-h-[85vh] bg-black flex flex-col items-center justify-center px-6 py-12">
        <div className="max-w-md w-full card bg-[#0d0d0d] border-[#222] p-8 md:p-10 flex flex-col items-center text-center">
          ...
          <div className="w-full flex flex-col gap-3">
            <button
              onClick={() => handleLogin('tindoynilo@gmail.com')}
              disabled={loggingIn}
              className="w-full flex items-center justify-center gap-3 bg-gold hover:bg-gold/90 text-black font-bold py-3.5 px-6 rounded-lg transition-all shadow-lg shadow-gold/10 disabled:opacity-50"
            >
              <ShieldCheck size={20} />
              <span>Sign in as Admin (tindoynilo@gmail.com)</span>
            </button>

            <button
              onClick={() => handleLogin()}
              disabled={loggingIn}
              className="w-full flex items-center justify-center gap-3 bg-[#181818] hover:bg-[#252525] border border-[#333] text-gray-300 font-semibold py-3 px-6 rounded-lg transition-all text-xs disabled:opacity-50"
            >
